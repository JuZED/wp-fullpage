...
class WP_Fullpage_Fullpage_Type_Metabox extends WP_Fullpage_Metabox_Base {
	...
	public function init( $dir = __DIR__, $file = __FILE__ ) {
		...
		$this->post_type = WPFP_FULLPAGE_PT;
	...
	public function render_fullpage_options_content( $post ) {
		...
		// Render metabox
		include( $this->rel_path . 'views/fullpage-options.php' );
...
} // END class WP_Fullpage_Fullpage_Type_Metabox

// instantiate the Settings class
$WP_Fullpage_Fullpage_Type_Metabox = new WP_Fullpage_Fullpage_Type_Metabox();
